function [j_el, residual_el, kappa_el, gausspoints_prop_mat_elem, nodes_prop_mat_elem, k_el] = func_elstif_Nonlocgradient(lmncoord,dofs,Delastic,kappa_el_previousinc,g,alpha_val,beta_val,e_delta,dmax,n_hood,weights,IsM,IsProj,quad_elem_order,ndof,ndof2,estar_shear_flag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if IsProj == 0
    ...
    stress_s1_el        = zeros(1,npoints);
    f_internal_uu_el    = zeros(number_of_nodes * ndof2,1);  
    ...
    for integ_point = 1:npoints
        ...
        [kappa, omega, domega_dkappa] = func_mazarmodel_Nonlocgradient(nonlocal_strain_el(1,integ_point),kappa_el_previousinc(1,integ_point),alpha_val,beta_val,e_delta,dmax,IsM);
    ...
    f_external_el = [zeros(number_of_nodes * ndof2,1); f_external_ee_el]; 
    ...
    elseif quad_elem_order == 2
        index_series = [1 2 17 3 4 18 5 6 19 7 8 20 9 10 21 11 12 22 13 14 23 15 16 24];
    else
        disp('Check your quad_elem_order variable')
    end   
