function func_plotmesh(xcoord,ycoord,damage,elocal,enonlocal_pred,model_name,last_iteration,increment,loadfactor,Res_F_F_norm,Res_u_norm,solver_string,tangent_string)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% =============================== PLOTTING ================================
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Initialize figure
f = figure("Position",[400 200 600 500]);
