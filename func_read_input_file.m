function [SolverID,TangentID,Modified_NR_flag,Staggered_flag,ncoord,ndof,quad_elem_order,lc, ... 
...
cellnumber       = cellnumber + 2;
Modified_NR_flag = str2double(model_parameters_cellarray{1}{cellnumber});
cellnumber       = cellnumber + 2;
Staggered_flag 	 = str2double(model_parameters_cellarray{1}{cellnumber});
...
cellnumber      = cellnumber + 2;
quad_elem_order = str2double(model_parameters_cellarray{1}{cellnumber});
...
cellnumber       = cellnumber + 2;
estar_shear_flag = str2double(model_parameters_cellarray{1}{cellnumber});
