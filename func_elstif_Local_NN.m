function [j_el, f_internal_el, res_e_el, damage_el, gausspoints_prop_mat_elem, nodes_prop_mat_elem, k_el] = func_elstif_Local_NN(lmncoord,dofs,Delastic,damage_el_previousinc,g,alpha_val,beta_val,e_delta,dmax,IsM,IsProj,enonlocal_strain_el,denonlocal_delocal_el,denonlocal_dx_el,denonlocal_dy_el,quad_elem_order,ndof,Modified_NR_flag,estar_shear_flag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
