function [kappa, omega, domega_dkappa] = func_mazarmodel_Nonlocgradient(nonlocal_strain,kappa_previousinc,alpha_val,beta_val,e_delta,dmax,IsM)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
