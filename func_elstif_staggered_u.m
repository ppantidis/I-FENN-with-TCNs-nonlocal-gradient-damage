function [j_el, residual_el, kappa_el, gausspoints_prop_mat_elem, nodes_prop_mat_elem, k_el] = func_elstif_staggered_u(lmncoord,dofs,Delastic,kappa_el_previousinc,g,alpha_val,beta_val,e_delta,dmax,n_hood,weights,IsM,IsProj,quad_elem_order,ndof,ndof2,estar_shear_flag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if IsProj == 0
    ...
    for integ_point = 1:npoints
        ...
        [kappa, omega, ~] = func_mazarmodel_Nonlocgradient(nonlocal_strain_el(1,integ_point),kappa_el_previousinc(1,integ_point),alpha_val,beta_val,e_delta,dmax,IsM);
    ...
    f_internal_el = f_internal_uu_el; % Size: 8x1
    ...
    f_external_el = zeros(number_of_nodes * ndof2,1);     
